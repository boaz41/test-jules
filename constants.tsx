...
export const NAVIGATION_ITEMS: { page: Page; label: string; icon: React.ReactNode }[] = [
    { page: 'dashboard', label: 'Dashboard', icon: <DashboardIcon /> },
    { page: 'customers', label: 'Customers', icon: <CustomersIcon /> },
    { page: 'new-sale', label: 'New Sale', icon: <NewSaleIcon /> },
    { page: 'products', label: 'Products', icon: <ProductsIcon /> },
    { page: 'transactions', label: 'Transactions', icon: <PaymentsIcon /> },
    { page: 'ledger', label: 'Ledger', icon: <LedgerIcon /> },
    { page: 'production', label: 'Production', icon: <ProductionIcon /> },
    { page: 'reports', label: 'Reports', icon: <ReportsIcon /> },
    { page: 'users', label: 'Users', icon: <UsersIcon /> },
    { page: 'audit-log', label: 'Audit Log', icon: <AuditLogIcon /> },
...
function UsersIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.284-1.255-.745-1.685A6.5 6.5 0 0012 15H7m5-9a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
    );
}
